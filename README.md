...
ブロック効果を考慮したことで、残差の平均平方が減少し、処理のF値（処理の平均平方/残差の平均平方）が増加しています。      
...
ブロック効果を誤差に含めても（変量効果として扱っても）、固定効果として計算した場合と結果は変わりません。
...
```
<br>
まとめると以下のような分散分析表ができます。 
<br><br>

| 要因 | 平方和 | 自由度 | 平方平均 | F値 | p値 |
|:---|:---:|---:|:---|:---:|---:|
|施肥 |371.8 |3 |123.95 |11.68 |0.00644* |
|ブロック |118.3 |2 |59.16 | | |
|誤差 |63.7 |6 |10.61 | | |
